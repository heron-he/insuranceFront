...
function UserInfoHeader(props: HeaderProps) {
    ...
    const loadingImgNode = <Skeleton text={{ rows: 0 }} image={{ style: { width: '64px', height: '64px' }, shape: 'circle' }} animation />
    return (
            ...
            <Space size={8} direction="vertical" align="center" className={styles['header-content']}>
                ...
                <div className={styles['user-msg']}>
                    <Space size={18}>
                        <div>
                            <IconUser />
                            <span className={styles['user-msg-text']}>{loading ? loadingNode : userInfo.jobName}</span>
                        </div>
                        <div>
                            <IconHome />
                            <span className={styles['user-msg-text']}>{loading ? loadingNode : userInfo.organizationName}</span>
                        </div>
                        <div>
                            <IconLocation />
                            <span className={styles['user-msg-text']}>{loading ? loadingNode : userInfo.locationName}</span>
                        </div>
                    </Space>
                </div>
            </Space>
