    ...
    return (
        <Card>
            ...
            <div className={styles['studio-wrapper']}>
                <img src="http://p1-arco.byteimg.com/tos-cn-i-uwbnlip3yd/c788fc704d32cf3b1136c7d45afc2669.png~tplv-uwbnlip3yd-webp.webp" className={styles['studio-preview']} />
                <div className={styles['studio-bar']}>
                    ...
                    <Typography.Text type="secondary">3,6000 {t['monitor.studioPreview.watching']}</Typography.Text>
                </div>
            </div>
        </Card>
    )
